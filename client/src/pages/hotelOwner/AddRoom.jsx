...
const AddRoom = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        const selectedAmenities = Object.values(inputs.amenities).some(val => val);
        const atLeastOneImage = Object.values(images).some(img => img);
            ...
            <div className="grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap">
                {Object.keys(images).map((key) => (
                    <label htmlFor={`roomImage${key}`} key={key}>
                        <img
                            className="max-h-[130px] cursor-pointer opacity-80"
