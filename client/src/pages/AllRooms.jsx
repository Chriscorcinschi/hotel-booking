...
const AllRooms = () => {
    ...
    //handle change for filters and soorting
    ...
    return (
        <div className="flex flex-col-reverse items-start justify-between lg:flex-row pt-28 md:pt-35 px-4 md:px-16 lg:px-24">
            <div>
                ...
                {filteredRooms.length === 0 && (
                    <p className="text-red-500 mt-6 text-base">
                        No rooms found.
                    </p>
                )}
                ...
                {filteredRooms.map((room) => (
                    <div key={room._id} 
                        ...
                        <div className="md:w-1/2 flex flex-col gap-2">
                            ...
                            <p onClick={() => {navigate(`/rooms/${room._id}`); window.scrollTo(0, 0);}} className="text-gray-500 text-3xl font-playfair cursor-pointer">{room.hotel.name}</p>
                            <div className="flex items-center">
                                <StarRating />
                                <p className="ml-2">200+ Reviews</p>
                            </div>
                            <div>
                                <img src={assets.locationIcon} alt="location-icon" className="w-4 h-4 inline-block mr-2" />
