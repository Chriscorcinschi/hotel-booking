                        ...
                        >
                            ...
                            <div className="flex flex-col md:flex-row">
                                <img
                                    ...
                                    alt="hotel-img"
                                    className="md:w-44 shadow object-cover"
                                />
                            ...
                            <div className="flex flex-col items-start justify-center pt-3">
                                ...
                                {!booking.isPaid && (
                                    <button
                                        ...
                                        className="px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-black hover:text-white hover:border-black transition-all cursor-pointer duration-200"
                                    >
                                        Pay Now
                                    </button>
                                )}
