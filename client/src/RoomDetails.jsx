        ...
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="flex flex-col lg:flex-row mt-6 gap-6">
                <div className="lg:w-1/2 w-full">
                    <img src={mainImage} alt="Room Image" className="w-full shadow-lg object-cover"/>
                </div>
                <div className="grid grid-cols-2 gap-4 lg:w-1/2 w-full">
                    {room?.images.length > 1 && room.images.map((image, index)=>(
                        ...
                        className={`w-full shadow-md object-cover cursor-pointer ${mainImage === image && 'outline-3 outline-orange-500'}`}/>
                    ))}
                </div>
            </div>
            ...
            <form className="flex flex-col md:flex-row items-center md:items-center justify-between bg-white rounded-md shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 mx-auto mt-16 max-w-6xl"> 
                ...
                <button 
                type="submite"
                className="bg-black  hover:bg-black-dull active:scale-95 transition-all text-white rounded-md max-w-1/2 max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer">
                    Check Availability
                </button>
            </form>
            ...
            {/*common specifications*/}
                ...
                <div className="flex flex-col items-start gap-4">
                    <div className="flex gap-4">
                        <img 
                        src={room.hotel.owner.images} alt="Host" 
                    ...
                    <button className="px-6 py-2.5 mt-4 rounded text-white bg-black hover:bg-black-dull transition-all cursor-pointer">Contact Now</button>
                </div>
        </div>
